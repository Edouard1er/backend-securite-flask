...
def get_message_forum():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            user_1 = _json["user_1"] or userInfo["id"]
            user_2 = _json["user_2"] or userInfo["id"]
    ...
    if request.method == 'DELETE':
        try:
            userInfo = getCurrentUserInfo()
            user_1 = flask.request.values.get('user_1') or userInfo["id"]
            user_2 = flask.request.values.get('user_2') or userInfo["id"]
